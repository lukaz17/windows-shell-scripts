...
#  unikey-install
#
#  Install/Update Unikey for current user. This also works as a version manager.
#
#  Homepage: https://www.unikey.org/
#
#  Usage:
#    unikey-install <version>
#
#  Example:
#    unikey-install 4.5-rc3
#    unikey-install v4.5-rc3
#
#  MIT License.
