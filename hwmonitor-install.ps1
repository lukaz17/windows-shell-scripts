...
#  hwmonitor-install
#
#  Install/Update HWMonitor for current user. This also works as a version manager.
#
#  Homepage: https://www.cpuid.com/softwares/hwmonitor.html
#
#  Usage:
#    hwmonitor-install <version>
#
#  Example:
#    hwmonitor-install 1.64
#    hwmonitor-install v1.64
#
#  MIT License.
...
# Application info
$PROGRAM_ID = "HWMonitor"
$PROGRAM_NAME = "HWMonitor"
$PROGRAM_EXEC = "HWMonitor_x64.exe"
