...
#  ollama-install
#
#  Install/Update Ollama for current user. This also works as a version manager.
#  If version is not specified, the latest version will be installed.
#
#  Homepage: https://ollama.com/
#
#  Usage:
#    ollama-install [<version>]
#
#  Example:
#    ollama-install
#    ollama-install 0.17.0
#    ollama-install v0.17.0
#
#  MIT License.
...
if (!(Test-Path "$($InstallEnv.InstallTarget)" -PathType Container)) {
	$BIN_ARCH_URI_AMD64 = "https://github.com/${GITHUB_OWNER}/${GITHUB_REPO}/releases/download/v${INSTALL_VERSION}/ollama-windows-amd64.zip"
	$BIN_ARCH_URI_ARM64 = "https://github.com/${GITHUB_OWNER}/${GITHUB_REPO}/releases/download/v${INSTALL_VERSION}/ollama-windows-amd64.zip"
