...
#  kilocode-install
#
#  Install/Update Kilo Code for current user. This also works as a version manager.
#  If version is not specified, the latest version will be installed.
#
#  Homepage: https://kilo.ai/
#
#  Usage:
#    kilocode-install [<version>]
#
#  Example:
#    kilocode-install
#    kilocode-install 7.1.22
#    kilocode-install v7.1.22
#
#  MIT License.
...
# Application info
$GITHUB_OWNER = "Kilo-Org"
$GITHUB_REPO = "kilocode"
$PROGRAM_ID = "Kilo Code"
$PROGRAM_EXEC = "kilo.exe"
...
if (!(Test-Path "$($InstallEnv.InstallTarget)" -PathType Container)) {
	$BIN_ARCH_URI_AMD64 = "https://github.com/${GITHUB_OWNER}/${GITHUB_REPO}/releases/download/v${INSTALL_VERSION}/kilo-windows-x64.zip"
	$BIN_ARCH_URI_ARM64 = "https://github.com/${GITHUB_OWNER}/${GITHUB_REPO}/releases/download/v${INSTALL_VERSION}/kilo-windows-arm64.zip"
