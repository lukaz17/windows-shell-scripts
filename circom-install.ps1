...
#  circom-install
#
#  Install/Update Circom 2 for current user. This also works as a version manager.
#  If version is not specified, the latest version will be installed.
#
#  Homepage: https://iden3.io/circom
#
#  Usage:
#    circom-install [<version>]
#
#  Example:
#    circom-install
#    circom-install 2.2.2
#    circom-install v2.2.2
#
#  MIT License.
