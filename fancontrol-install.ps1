...
#  fancontrol-install
#
#  Install/Update FanControl for current user. This also works as a version manager.
#  If version is not specified, the latest version will be installed.
#
#  Homepage: https://getfancontrol.com/
#
#  Usage:
#    fancontrol-install [<version>]
#
#  Example:
#    fancontrol-install
#    fancontrol-install 271
#    fancontrol-install v271
#
#  MIT License.
...
# Application info
$PROGRAM_ID="FanControl"
$PROGRAM_NAME="FanControl"
$PROGRAM_EXEC="FanControl.exe"
...
$INSTALL_VERSION = Get-InstallVersionFromGithub -Owner "$($InstallSrc.GithubOwner)" -Repo "$($InstallSrc.GithubRepo)" -FallbackVersion "${INSTALL_VERSION}" -TagPrefix "V"
